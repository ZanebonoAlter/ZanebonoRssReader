...
type AISummaryPromptBuilder struct {
	preferenceService *preferences.PreferenceService
	db                *gorm.DB
}
...
func NewAISummaryPromptBuilder(prefService *preferences.PreferenceService, db *gorm.DB) *AISummaryPromptBuilder {
