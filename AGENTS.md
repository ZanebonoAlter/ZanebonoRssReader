...
This project is indexed by GitNexus as **my-robot** (2323 symbols, 5289 relationships, 184 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
