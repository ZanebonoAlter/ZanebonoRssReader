...
This project is indexed by GitNexus as **my-robot** (1820 symbols, 3957 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
