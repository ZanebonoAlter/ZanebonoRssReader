...
This project is indexed by GitNexus as **my-robot** (1409 symbols, 3016 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
