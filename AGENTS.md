...
This project is indexed by GitNexus as **my-robot** (12435 symbols, 21682 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
