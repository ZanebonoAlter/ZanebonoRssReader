...
This project is indexed by GitNexus as **my-robot** (3172 symbols, 8292 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
