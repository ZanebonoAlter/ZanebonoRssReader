...
This project is indexed by GitNexus as **my-robot** (2256 symbols, 5056 relationships, 178 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
