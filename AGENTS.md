...
This project is indexed by GitNexus as **my-robot** (1408 symbols, 3014 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
