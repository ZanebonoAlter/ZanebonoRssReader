...
This project is indexed by GitNexus as **my-robot** (2350 symbols, 5374 relationships, 186 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
