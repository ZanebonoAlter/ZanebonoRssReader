...
This project is indexed by GitNexus as **my-robot** (1400 symbols, 2997 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
